...
//
//
//// bnu055_writeData( uint8_t reg , uint8_t data);
//// bnu055_readData( uint8_t reg , uint8_t * data, uint8_t len);
//// bnu055_dealy(int time)
//
////I2C_HandleTypeDef *_bno055_i2c;
//
////void bno055_assignI2C(I2C_HandleTypeDef *hi2c_device) {
////  _bno055_i2c = hi2c_device;
////}
////
////void bno055_writeData(uint8_t reg, uint8_t data){
////	HAL_I2C_Mem_Write(_bno055_i2c, BNO055_I2C_ADDR, reg, 1, &data, 1, HAL_MAX_DELAY);
////}
////void bno055_readData(uint8_t reg, uint8_t *data, uint8_t len){
////	HAL_I2C_Mem_Read(_bno055_i2c, BNO055_I2C_ADDR, reg, 1, data, len, HAL_MAX_DELAY);
////}
